...
exports.searchform = async (req, res) => {
    ...
    return res.render("job_insert_update/home", {
...
exports.searchcombo = async (req, res) => {
    try {
...
exports.updateform = async (req, res) => {
    ...
    if (!fname || !currdesignation || !email || !gender || !address || !state || !lname || !dob || !phone || !relnstatus || !city || !zipcode
        ...
        return res.render("job_insert_update/home", {
            route: "/update", basicdetail: null, educationdetial: [], workexperience: [], languageknown: [],
        ...
        return res.render("job_insert_update/home", { route:"/update",
...
exports.results = async (req, res) => {
    ...
    res.render("job_insert_update/show", { result });

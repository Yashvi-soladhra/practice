...
CREATE TABLE `workexperiences` (
  ...
  CONSTRAINT `workexperiences_ibfk_1` FOREIGN KEY (`candid`) REFERENCES `basicdetails` (`candid`)
...
INSERT INTO `workexperiences` VALUES (1,1,'covrizee','devloper','2020-12-12','2021-12-12'),(2,2,'covrizee','devloper','2020-12-12','2021-12-12'),(3,3,'tata','devloper','2020-12-12','2021-12-12');
